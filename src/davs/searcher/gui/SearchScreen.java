...
public class SearchScreen extends javax.swing.JFrame {
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
    	...
    	try
			...
			{
				JOptionPane.showMessageDialog(this, "Application initialization failed, restart application");
			}
    	...
    	else JOptionPane.showMessageDialog(this, "Nothing was added to the index");
    ...
    private void mouseClicked(String term)
    	{
        	...
        	if(MainProgram.isSpellCheckEnabled)
        		suggestions = MainProgram.spellCheck.getSpellSuggestions(newTerm, 3);
        	
        	if(suggestions != null && suggestions.length >= 1 && MainProgram.isSpellCheckEnabled)
        		{
        	...
        	if(suggestions != null && suggestions.length >= 2 && MainProgram.isSpellCheckEnabled)
        		{
        	...
        	if(suggestions != null && suggestions.length >= 3 && MainProgram.isSpellCheckEnabled)
        		{
	...
	public void setSearchHelper(davs.searcher.program.SearchScreenHelper searchHelper)
		{
