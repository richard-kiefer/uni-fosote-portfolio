		...
		public static void main(String[] args)
			{
				...
				try
					...
					{
						//If spellCheck is not initialized, don't even bother with suggestions
						isSpellCheckEnabled = false;
						
						System.err.println("Spell checking is not supported");
						System.err.println("Make sure file dict is in your working directory");
					}
					...
					else new IndexNotFound().setVisible(true);
